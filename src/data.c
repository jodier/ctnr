...
bool ctnr_data_pop_head(ctnr_data_t *data, buff_t buff, size_t *size, enum_t *type)
{
	...
	if(item->size != ctnr_memory_free(item) - sizeof(ctnr_data_item_t))
	{
		ctnr_panic("ctnr_data_pop_head() - runtime error !\n");
	}
...
bool ctnr_data_pop_tail(ctnr_data_t *data, buff_t buff, size_t *size, enum_t *type)
{
	ctnr_data_item_t *item;
...
bool ctnr_data_get_head(ctnr_data_t *data, buff_t buff, size_t *size, enum_t *type)
{
	ctnr_data_item_t *item;
...
bool ctnr_data_get_tail(ctnr_data_t *data, buff_t buff, size_t *size, enum_t *type)
{
	ctnr_data_item_t *item;
...
void ctnr_data_append(ctnr_data_t *data1, ctnr_data_t *data2)
{
	ctnr_data_item_t *item;
...
size_t ctnr_data_clear(ctnr_data_t *data)
{
	size_t result;
	...
	/**/		ctnr_list_remove(data->list, item);
	/**/
	/**/		data->size -= ctnr_memory_free(item) - sizeof(ctnr_data_item_t);
	/**/	}
	/**/
	/**/	if(data->size != 0)
	/**/	{
	/**/		ctnr_panic("ctnr_data_clear() - runtime error !\n");
	/**/	}
